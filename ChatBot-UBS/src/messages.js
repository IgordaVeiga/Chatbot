...
A UBS oferece consultas de enfermagem para:
- Pré-natal
- Curativos
...
Para realizar exames fora da rede básica, é obrigatório apresentar o encaminhamento médico, Cartão SUS e documento com foto.
...
Procure o setor de regulação ou a recepção da própria UBS portando as guias médicas e seus documentos pessoais.
...
Apresente a receita original dentro da validade (emitida pelo SUS) juntamente com o documento do paciente na farmácia da unidade.

Digite o número da opção desejada, [0] para voltar ou "menu" para o início.`,

        '5': `👥 Informações sobre gestantes, crianças e idosos

Escolha o grupo que deseja:
1️⃣ - Gestantes
2️⃣ - Crianças
3️⃣ - Idosos
...
Acompanhamento de doenças crônicas (Hiperdia), além de um grupo de comunicação exclusivo via WhatsApp para avisos e orientações.
...
Compareça à recepção com seu comprovante de residência. A equipe informará qual a sua equipe de Saúde da Família com base na sua rua.

Digite o número da opção desejada, [0] para voltar ou "menu" para o início.`,

        '6.2': `🏠 6.2 Morar em outra área:

A unidade realiza o acolhimento e orientação inicial, mas para acompanhamentos contínuos você será direcionado à sua UBS de referência.

Digite o número da opção desejada, [0] para voltar ou "menu" para o início.`,

        '6.3': `⚙️ 6.3 Como funciona o atendimento:

A Estratégia Saúde da Família (ESF) trabalha de forma territorial fixa, focando na prevenção e no cuidado do seu núcleo familiar.
...
Os ACS realizam visitas domiciliares periódicas para cadastramento, monitoramento de gestantes, idosos e ações de prevenção na comunidade.
...
Aguarde um momento, sua mensagem está sendo direcionada para o balcão de atendimento da recepção.
...
Deseja:
1️⃣ - Saber eventos atuais
2️⃣ - Saber datas das ações

Digite o número da opção desejada, [0] para voltar ou "menu" para o início.`,

        '8.1': `🗓️ 8.1 Campanhas e Eventos:

A UBS promove rotineiramente campanhas de vacinação, mutirões de saúde, ações educativas, além de distribuição assistida de cestas básicas.

Digite o número da opção desejada, [0] para voltar ou "menu" para o início.`,

        '8.2': `📅 8.2 Datas das ações:

As datas das campanhas e ações são divulgadas no mural da UBS, na recepção e nos grupos de WhatsApp da comunidade. Acompanhe também os avisos dos Agentes Comunitários de Saúde (ACS).
