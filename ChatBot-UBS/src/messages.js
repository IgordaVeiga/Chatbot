const NAV_HINT = `↩️ [0] voltar  •  🏠 "menu" para o início`;
...
${NAV_HINT}`,
        ...
        '2.9': `👶 Teste do pezinho

Realizado das *08h às 11h*.

${NAV_HINT}`,

        '2.10': `💊 Injetáveis (intramuscular)
...
${NAV_HINT}`,
        ...
        '6.3': `⚙️ Como funciona o atendimento
...
${NAV_HINT}`,
        ...
        '7.1': `👣 Agente Comunitário de Saúde (ACS)
